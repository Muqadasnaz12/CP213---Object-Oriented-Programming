...
public class MovieUtilities {
    ...
    public static Movie readMovie(final String line) {
    	...
    	String title = feilds[0];
    	int year = Integer.parseInt(feilds[1]);
    	String director = feilds[2];
    	double rating = Double.parseDouble(feilds[3]);
    	int genre = Integer.parseInt(feilds[4]);
    	return new Movie(title,year,director,rating,genre);
    }
